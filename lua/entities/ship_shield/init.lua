...
function ENT:Initialize()
	...
	if (model == "sg_vehicle_shuttle") then self.Entity:SetModel("models/Madman07/shields/destiny_shield.mdl");
	elseif (model == "sg_vehicle_hatak") then self.Entity:SetModel("models/Madman07/shields/hatak_shield.mdl");
	elseif (model == "sg_vehicle_daedalus") then self.Entity:SetModel("models/Madman07/shields/daedalus_shield.mdl");
	elseif (model == "sg_vehicle_aurora") then self.Entity:SetModel("models/Madman07/shields/aurora_shield.mdl");
